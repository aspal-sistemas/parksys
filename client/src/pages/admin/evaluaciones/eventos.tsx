...
const EvaluacionesEventos = () => {
  ...
  const { data: evaluations = [], isLoading } = useQuery<EventEvaluation[]>({
    queryKey: ['/api/evaluations/events'],
  });

  // Filtrar evaluaciones
  const filteredEvaluations = evaluations.filter((evaluation) => {
    const matchesSearch = 
      evaluation.eventName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      evaluation.evaluatorName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
      evaluation.eventType?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const stats = {
    ...
    totalHours: evaluations.reduce((sum, e) => sum + (e.duration || 0), 0)
  };

  if (isLoading) {
    return (
      <AdminLayout title="Evaluaciones de Eventos" subtitle="Cargando evaluaciones de eventos...">
        <div className="p-6">
  ...
  return (
    <AdminLayout title="Evaluaciones de Eventos" subtitle="Gestión y seguimiento de evaluaciones de eventos">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex gap-2 flex-1">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                placeholder="Buscar por evento, tipo o parque..."
                value={searchTerm}
          ...
          {filteredEvaluations.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-500">No se encontraron evaluaciones de eventos</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <div className="flex gap-4 text-sm text-gray-600">
                          <span>Asistentes: {evaluation.attendees || 0}</span>
                          <span>Duración: {evaluation.duration || 0}h</span>
                        </div>
