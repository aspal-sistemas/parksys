...
interface ConcessionaireEvaluation {
  id: number;
...
const EvaluacionesConcesionarios = () => {
  ...
  const { data: evaluations = [], isLoading } = useQuery<ConcessionaireEvaluation[]>({
    queryKey: ['/api/evaluations/concessionaires'],
  });
  ...
  const filteredEvaluations = evaluations.filter((evaluation) => {
    const matchesSearch = 
      ...
      evaluation.businessType?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const stats = {
    ...
    averageRating: evaluations.length > 0 
      ...
      : 0,
    totalRevenue: evaluations.reduce((sum, e) => sum + (e.monthlyRevenue || 0), 0)
  };

  if (isLoading) {
    return (
      <AdminLayout title="Evaluaciones de Concesionarios" subtitle="Cargando evaluaciones de concesionarios...">
        <div className="p-6">
  ...
  return (
    <AdminLayout title="Evaluaciones de Concesionarios" subtitle="Gestión y seguimiento de evaluaciones de concesionarios">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex gap-2 flex-1">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                placeholder="Buscar por concesionario, tipo o parque..."
                value={searchTerm}
          ...
          {filteredEvaluations.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-500">No se encontraron evaluaciones de concesionarios</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">
                          {evaluation.concessionaireName}
                        </h3>
                        <p className="text-sm text-gray-600">
                          Tipo de negocio: {evaluation.businessType}
                        </p>
                        <p className="text-sm text-gray-600">
                        ...
                        <p className="text-sm text-gray-600">
                          Ingresos mensuales: {formatCurrency(evaluation.monthlyRevenue || 0)}
                        </p>
