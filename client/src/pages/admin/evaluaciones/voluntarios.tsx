...
const EvaluacionesVoluntarios = () => {
  ...
  const filteredEvaluations = evaluations.filter((evaluation) => {
    const matchesSearch = 
      evaluation.volunteerName?.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const stats = {
    ...
    averageRating: evaluations.length > 0 
      ...
      : 0,
    totalHours: evaluations.reduce((sum, e) => sum + (e.hoursCompleted || 0), 0)
  };

  if (isLoading) {
    return (
      <AdminLayout title="Evaluaciones de Voluntarios" subtitle="Cargando evaluaciones de voluntarios...">
        <div className="p-6">
  ...
  return (
    <AdminLayout title="Evaluaciones de Voluntarios" subtitle="Gestión y seguimiento de evaluaciones de voluntarios">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex gap-2 flex-1">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                placeholder="Buscar por voluntario, actividad o evaluador..."
                value={searchTerm}
          ...
          {filteredEvaluations.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-500">No se encontraron evaluaciones de voluntarios</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900">
                          {evaluation.volunteerName}
                        </h3>
                        <p className="text-sm text-gray-600">
                          Actividad: {evaluation.activityName}
                        </p>
                        <p className="text-sm text-gray-600">
                          Evaluado por: {evaluation.evaluatorName}
                        </p>
                        <p className="text-sm text-gray-600">
                          Horas completadas: {evaluation.hoursCompleted || 0}h
                        </p>
