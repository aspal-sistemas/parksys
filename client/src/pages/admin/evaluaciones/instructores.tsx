...
const EvaluacionesInstructores = () => {
  ...
  if (isLoading) {
    return (
      <AdminLayout title="Evaluaciones de Instructores" subtitle="Cargando evaluaciones de instructores...">
        <div className="p-6">
  ...
  return (
    <AdminLayout title="Evaluaciones de Instructores" subtitle="Gestión y seguimiento de evaluaciones de instructores">
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
          <div className="flex gap-2 flex-1">
            <div className="relative flex-1 max-w-sm">
              ...
              <Input
                placeholder="Buscar por instructor, actividad o evaluador..."
                value={searchTerm}
          ...
          {filteredEvaluations.length === 0 ? (
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <p className="text-gray-500">No se encontraron evaluaciones de instructores</p>
