  ...
  return (
    <main className="flex-1 flex flex-col">
      ...
      <div className={`flex flex-col md:flex-row flex-1 ${mapExpanded ? 'flex-col' : ''}`}>
        {/* Sección de mapa - más compacta y con tamaño fijo */}
        <div className={`${mapExpanded ? 'w-full h-[70vh]' : 'md:w-1/3 lg:w-1/3 h-[300px] md:h-[500px]'} transition-all duration-300 ${mapExpanded ? 'order-first' : 'md:order-last'}`}>
