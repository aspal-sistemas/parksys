...
- June 21, 2025. Sistema de gestión de parques unificado implementado - Consolidada toda la funcionalidad en una sola página editora con 9 pestañas organizadas: Información Básica, Ubicación y Contacto, Características, Amenidades, Actividades, Árboles, Incidencias, Voluntarios y Multimedia. Eliminado ícono de llave de tuercas y página park-manage.tsx. Ahora solo existe un ícono de lápiz que lleva a la gestión completa del parque (/admin/parks/X/view)
