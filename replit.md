...
- June 28, 2025. Reorganización de secciones en landing pages completada - Sección "Documentos y Reglamentos" reubicada después de "Voluntarios Activos" y sección "Galería de Imágenes" movida después de "¡Realiza tu evento aquí!" según solicitud del usuario. Orden final optimizado: Actividades → Concesiones y Servicios → Instalaciones → Información Adicional → Instructores → Voluntarios Activos → Documentos y Reglamentos → Eventos → Galería. Layout mejorado para mejor flujo de información del usuario
