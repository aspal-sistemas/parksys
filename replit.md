...
- June 24, 2025. Matriz de flujo de efectivo implementada completamente - Sistema funcional que compara datos proyectados vs reales con cálculo automático de varianzas. Integración con planificación presupuestaria para mostrar diferencias entre proyecciones y datos actuales. Funcionalidad de importar/exportar CSV, filtros por año y parque, visualización unificada de ingresos y egresos con totales automáticos. Ruta /admin/finance/cash-flow-matrix registrada correctamente en App.tsx. Cabecera fija pendiente de optimización futura
