...
- June 28, 2025. Reorganización de secciones en landing pages completada - Sección "Documentos y Reglamentos" reubicada después de "Voluntarios Activos" según solicitud del usuario. Orden final optimizado: Actividades → Concesiones y Servicios → Galería → Instalaciones → Información Adicional → Instructores → Voluntarios Activos → Documentos y Reglamentos → Eventos. Layout mejorado para mejor flujo de información del usuario
