...
- June 24, 2025. Sección de Eventos separada creada en sidebar - Movido "Nuevo Evento" de Actividades a nueva sección "Eventos" que incluye: Nuevo Evento, Calendario de Eventos y Eventos AMBU. Organización clara que diferencia eventos (con registro formal) de actividades (programación regular). Calendario de eventos creado con vista mensual y próximos eventos
