...
- **Activities and Evaluations Layout Restructure**: Reorganized the activities section into a grid layout with Activities (2/3 width) and Citizen Evaluations (1/3 width) side-by-side. Moved the Citizen Evaluations module from the sidebar to integrate with the main content flow, creating a more cohesive user experience with better visual balance.
