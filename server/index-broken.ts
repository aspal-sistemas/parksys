...
// Global state variables for initialization - simplified for deployment
...
app.get("/cash-flow-matrix-data", async (req: Request, res: Response) => {
  try {
    // Always try to return data, fallback to empty arrays if database not ready
...
// Server startup logic wrapped in async function
(async () => {
