  ...
  apiRouter.post('/accounting/import-sat-codes', isAuthenticated, async (req: Request, res: Response) => {
    try {
      ...
      const satCodes = [
        ...
        // COSTOS - 500
        { code: '500', name: 'Costos', level: 1, parent_code: null, account_nature: 'debit', section: 'Costos' },
        { code: '501', name: 'Costos de administración', level: 2, parent_code: '500', account_nature: 'debit', section: 'Costos' },
        { code: '501.01', name: 'Sueldos y salarios', level: 3, parent_code: '501', account_nature: 'debit', section: 'Costos' },
        { code: '501.02', name: 'Honorarios', level: 3, parent_code: '501', account_nature: 'debit', section: 'Costos' },
        { code: '501.03', name: 'Arrendamientos', level: 3, parent_code: '501', account_nature: 'debit', section: 'Costos' },
        { code: '501.04', name: 'Servicios públicos', level: 3, parent_code: '501', account_nature: 'debit', section: 'Costos' },
        { code: '501.05', name: 'Mantenimiento y reparaciones', level: 3, parent_code: '501', account_nature: 'debit', section: 'Costos' },
        { code: '502', name: 'Costos de venta', level: 2, parent_code: '500', account_nature: 'debit', section: 'Costos' },
        { code: '502.01', name: 'Publicidad y promoción', level: 3, parent_code: '502', account_nature: 'debit', section: 'Costos' },
        { code: '502.02', name: 'Comisiones sobre ventas', level: 3, parent_code: '502', account_nature: 'debit', section: 'Costos' },
        { code: '503', name: 'Costos financieros', level: 2, parent_code: '500', account_nature: 'debit', section: 'Costos' },
        { code: '503.01', name: 'Intereses pagados', level: 3, parent_code: '503', account_nature: 'debit', section: 'Costos' },
        { code: '503.02', name: 'Comisiones bancarias', level: 3, parent_code: '503', account_nature: 'debit', section: 'Costos' },
        { code: '504', name: 'Otros costos', level: 2, parent_code: '500', account_nature: 'debit', section: 'Costos' },
        { code: '504.01', name: 'Otros costos', level: 3, parent_code: '504', account_nature: 'debit', section: 'Costos' },
        
        // GASTOS - 600 (Códigos SAT Oficiales)
        { code: '600', name: 'Gastos', level: 1, parent_code: null, account_nature: 'debit', section: 'Gastos' },
        { code: '601', name: 'Gastos generales', level: 2, parent_code: '600', account_nature: 'debit', section: 'Gastos' },
        { code: '601.01', name: 'Sueldos y salarios', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.02', name: 'Compensaciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.03', name: 'Tiempos extras', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.04', name: 'Premios de asistencia', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.05', name: 'Premios de puntualidad', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.06', name: 'Vacaciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.07', name: 'Prima vacacional', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.08', name: 'Prima dominical', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.09', name: 'Días festivos', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.10', name: 'Gratificaciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.11', name: 'Primas de antigüedad', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.12', name: 'Aguinaldo', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.13', name: 'Indemnizaciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.14', name: 'Destajo', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.15', name: 'Despensa', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.16', name: 'Transporte', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.17', name: 'Servicio médico', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.18', name: 'Ayuda en gastos funerarios', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.19', name: 'Fondo de ahorro', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.20', name: 'Cuotas sindicales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.21', name: 'PTU', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.22', name: 'Estímulo al personal', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.23', name: 'Previsión social', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.24', name: 'Aportaciones para el plan de jubilación', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.25', name: 'Otras prestaciones al personal', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.26', name: 'Cuotas al IMSS', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.27', name: 'Aportaciones al infonavit', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.28', name: 'Aportaciones al SAR', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.29', name: 'Impuesto estatal sobre nóminas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.30', name: 'Otras aportaciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.31', name: 'Asimilados a salarios', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.32', name: 'Servicios administrativos', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.33', name: 'Servicios administrativos partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.34', name: 'Honorarios a personas físicas residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.35', name: 'Honorarios a personas físicas residentes nacionales partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.36', name: 'Honorarios a personas físicas residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.37', name: 'Honorarios a personas físicas residentes del extranjero partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.38', name: 'Honorarios a personas morales residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.39', name: 'Honorarios a personas morales residentes nacionales partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.40', name: 'Honorarios a personas morales residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.41', name: 'Honorarios a personas morales residentes del extranjero partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.42', name: 'Honorarios aduanales personas físicas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.43', name: 'Honorarios aduanales personas morales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.44', name: 'Honorarios al consejo de administración', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.45', name: 'Arrendamiento a personas físicas residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.46', name: 'Arrendamiento a personas morales residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.47', name: 'Arrendamiento a residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.48', name: 'Combustibles y lubricantes', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.49', name: 'Viáticos y gastos de viaje', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.50', name: 'Teléfono, internet', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.51', name: 'Agua', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.52', name: 'Energía eléctrica', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.53', name: 'Vigilancia y seguridad', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.54', name: 'Limpieza', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.55', name: 'Papelería y artículos de oficina', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.56', name: 'Mantenimiento y conservación', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.57', name: 'Seguros y fianzas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.58', name: 'Otros impuestos y derechos', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.59', name: 'Recargos fiscales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.60', name: 'Cuotas y suscripciones', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.61', name: 'Propaganda y publicidad', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.62', name: 'Capacitación al personal', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.63', name: 'Donativos y ayudas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.64', name: 'Asistencia técnica', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.65', name: 'Regalías sujetas a otros porcentajes', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.66', name: 'Regalías sujetas al 5%', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.67', name: 'Regalías sujetas al 10%', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.68', name: 'Regalías sujetas al 15%', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.69', name: 'Regalías sujetas al 25%', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.70', name: 'Regalías sujetas al 30%', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.71', name: 'Regalías sin retención', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.72', name: 'Fletes y acarreos', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.73', name: 'Gastos de importación', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.74', name: 'Comisiones sobre ventas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.75', name: 'Comisiones por tarjetas de crédito', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.76', name: 'Patentes y marcas', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.77', name: 'Uniformes', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.78', name: 'Prediales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.79', name: 'Gastos generales de urbanización', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.80', name: 'Gastos generales de construcción', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.81', name: 'Fletes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.82', name: 'Recolección de bienes del sector agropecuario y/o ganadero', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.83', name: 'Gastos no deducibles (sin requisitos fiscales)', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        { code: '601.84', name: 'Otros gastos generales', level: 3, parent_code: '601', account_nature: 'debit', section: 'Gastos' },
        
        // Gastos de venta - 602
        { code: '602', name: 'Gastos de venta', level: 2, parent_code: '600', account_nature: 'debit', section: 'Gastos' },
        { code: '602.01', name: 'Sueldos y salarios', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.02', name: 'Compensaciones', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.48', name: 'Combustibles y lubricantes', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.49', name: 'Viáticos y gastos de viaje', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.50', name: 'Teléfono, internet', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.61', name: 'Propaganda y publicidad', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.74', name: 'Comisiones sobre ventas', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        { code: '602.84', name: 'Otros gastos de venta', level: 3, parent_code: '602', account_nature: 'debit', section: 'Gastos' },
        
        // Gastos de administración - 603
        { code: '603', name: 'Gastos de administración', level: 2, parent_code: '600', account_nature: 'debit', section: 'Gastos' },
        { code: '603.01', name: 'Sueldos y salarios', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.02', name: 'Compensaciones', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.12', name: 'Aguinaldo', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.26', name: 'Cuotas al IMSS', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.27', name: 'Aportaciones al infonavit', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.50', name: 'Teléfono, internet', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.56', name: 'Mantenimiento y conservación', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' },
        { code: '603.84', name: 'Otros gastos de administración', level: 3, parent_code: '603', account_nature: 'debit', section: 'Gastos' }
      ];
