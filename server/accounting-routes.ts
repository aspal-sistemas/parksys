  ...
  apiRouter.post('/accounting/import-sat-codes', isAuthenticated, async (req: Request, res: Response) => {
    try {
      ...
      const satCodes = [
        ...
        // CAPITAL - 300
        { code: '300', name: 'Capital', level: 1, parent_code: null, account_nature: 'credit', type: 'Capital' },
        { code: '301', name: 'Capital social', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '301.01', name: 'Capital social', level: 3, parent_code: '301', account_nature: 'credit', type: 'Capital' },
        { code: '302', name: 'Aportaciones para futuros aumentos de capital', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '302.01', name: 'Aportaciones para futuros aumentos de capital', level: 3, parent_code: '302', account_nature: 'credit', type: 'Capital' },
        { code: '303', name: 'Prima en venta de acciones', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '303.01', name: 'Prima en venta de acciones', level: 3, parent_code: '303', account_nature: 'credit', type: 'Capital' },
        { code: '304', name: 'Reserva legal', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '304.01', name: 'Reserva legal', level: 3, parent_code: '304', account_nature: 'credit', type: 'Capital' },
        { code: '305', name: 'Otras reservas', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '305.01', name: 'Otras reservas', level: 3, parent_code: '305', account_nature: 'credit', type: 'Capital' },
        { code: '306', name: 'Utilidades retenidas', level: 2, parent_code: '300', account_nature: 'credit', type: 'Capital' },
        { code: '306.01', name: 'Utilidades retenidas', level: 3, parent_code: '306', account_nature: 'credit', type: 'Capital' },
        
        // INGRESOS - 400
        { code: '400', name: 'Ingresos', level: 1, parent_code: null, account_nature: 'credit', type: 'Ingresos' },
        { code: '401', name: 'Ingresos por ventas', level: 2, parent_code: '400', account_nature: 'credit', type: 'Ingresos' },
        { code: '401.01', name: 'Ventas', level: 3, parent_code: '401', account_nature: 'credit', type: 'Ingresos' },
        { code: '402', name: 'Ingresos por servicios', level: 2, parent_code: '400', account_nature: 'credit', type: 'Ingresos' },
        { code: '402.01', name: 'Ingresos por servicios', level: 3, parent_code: '402', account_nature: 'credit', type: 'Ingresos' },
        { code: '403', name: 'Ingresos por arrendamiento', level: 2, parent_code: '400', account_nature: 'credit', type: 'Ingresos' },
        { code: '403.01', name: 'Ingresos por arrendamiento', level: 3, parent_code: '403', account_nature: 'credit', type: 'Ingresos' },
        { code: '404', name: 'Ingresos por intereses', level: 2, parent_code: '400', account_nature: 'credit', type: 'Ingresos' },
        { code: '404.01', name: 'Ingresos por intereses', level: 3, parent_code: '404', account_nature: 'credit', type: 'Ingresos' },
        { code: '405', name: 'Otros ingresos', level: 2, parent_code: '400', account_nature: 'credit', type: 'Ingresos' },
        { code: '405.01', name: 'Otros ingresos', level: 3, parent_code: '405', account_nature: 'credit', type: 'Ingresos' },
        
        // COSTOS - 500
        { code: '500', name: 'Costos', level: 1, parent_code: null, account_nature: 'debit', type: 'Costos' },
        { code: '501', name: 'Costos de administración', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '501.01', name: 'Sueldos y salarios', level: 3, parent_code: '501', account_nature: 'debit', type: 'Costos' },
        { code: '501.02', name: 'Honorarios', level: 3, parent_code: '501', account_nature: 'debit', type: 'Costos' },
        { code: '501.03', name: 'Arrendamientos', level: 3, parent_code: '501', account_nature: 'debit', type: 'Costos' },
        { code: '501.04', name: 'Servicios públicos', level: 3, parent_code: '501', account_nature: 'debit', type: 'Costos' },
        { code: '501.05', name: 'Mantenimiento y reparaciones', level: 3, parent_code: '501', account_nature: 'debit', type: 'Costos' },
        { code: '502', name: 'Costos de venta', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '502.01', name: 'Publicidad y promoción', level: 3, parent_code: '502', account_nature: 'debit', type: 'Costos' },
        { code: '502.02', name: 'Comisiones sobre ventas', level: 3, parent_code: '502', account_nature: 'debit', type: 'Costos' },
        { code: '503', name: 'Costos financieros', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '503.01', name: 'Intereses pagados', level: 3, parent_code: '503', account_nature: 'debit', type: 'Costos' },
        { code: '503.02', name: 'Comisiones bancarias', level: 3, parent_code: '503', account_nature: 'debit', type: 'Costos' },
        { code: '504', name: 'Otros costos', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '504.01', name: 'Otros costos', level: 3, parent_code: '504', account_nature: 'debit', type: 'Costos' },
        
        // COSTOS ADICIONALES - 500 (Códigos SAT Oficiales según documento)
        { code: '505', name: 'Costos de producción', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '505.01', name: 'Materia prima directa', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.02', name: 'Mano de obra directa', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.03', name: 'Gastos indirectos de fabricación', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.04', name: 'Depreciación de maquinaria', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.05', name: 'Mantenimiento de equipos', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.06', name: 'Servicios de producción', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.07', name: 'Mermas y desperdicios', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.08', name: 'Control de calidad', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.09', name: 'Empaque y embalaje', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        { code: '505.10', name: 'Otros costos de producción', level: 3, parent_code: '505', account_nature: 'debit', type: 'Costos' },
        
        { code: '506', name: 'Costo de ventas', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '506.01', name: 'Costo de mercancías vendidas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.02', name: 'Costo de productos terminados', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.03', name: 'Costo de servicios prestados', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.04', name: 'Devoluciones sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.05', name: 'Rebajas sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.06', name: 'Descuentos sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.07', name: 'Bonificaciones sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.08', name: 'Fletes sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.09', name: 'Seguros sobre ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        { code: '506.10', name: 'Otros costos de ventas', level: 3, parent_code: '506', account_nature: 'debit', type: 'Costos' },
        
        { code: '507', name: 'Costos operativos', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '507.01', name: 'Costos de operación', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.02', name: 'Costos de mantenimiento', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.03', name: 'Costos de logística', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.04', name: 'Costos de distribución', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.05', name: 'Costos de almacenamiento', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.06', name: 'Costos de transporte', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.07', name: 'Costos de seguridad', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.08', name: 'Costos de limpieza', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.09', name: 'Costos de servicios públicos', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        { code: '507.10', name: 'Otros costos operativos', level: 3, parent_code: '507', account_nature: 'debit', type: 'Costos' },
        
        { code: '508', name: 'Costos financieros', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '508.01', name: 'Intereses sobre préstamos', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.02', name: 'Comisiones financieras', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.03', name: 'Gastos por financiamiento', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.04', name: 'Diferencias cambiarias', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.05', name: 'Pérdidas por fluctuación cambiaria', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.06', name: 'Costos por garantías', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.07', name: 'Costos por seguros', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.08', name: 'Costos por fianzas', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        { code: '508.09', name: 'Otros costos financieros', level: 3, parent_code: '508', account_nature: 'debit', type: 'Costos' },
        
        { code: '509', name: 'Costos extraordinarios', level: 2, parent_code: '500', account_nature: 'debit', type: 'Costos' },
        { code: '509.01', name: 'Pérdidas por siniestros', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.02', name: 'Pérdidas por obsolescencia', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.03', name: 'Pérdidas por deterioro', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.04', name: 'Castigos de cuentas incobrables', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.05', name: 'Pérdidas por robo', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.06', name: 'Pérdidas por caso fortuito', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.07', name: 'Pérdidas por fuerza mayor', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.08', name: 'Multas y sanciones', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        { code: '509.09', name: 'Otros costos extraordinarios', level: 3, parent_code: '509', account_nature: 'debit', type: 'Costos' },
        
        // GASTOS - 600 (Códigos SAT Oficiales)
        { code: '600', name: 'Gastos', level: 1, parent_code: null, account_nature: 'debit', type: 'Gastos' },
        { code: '601', name: 'Gastos generales', level: 2, parent_code: '600', account_nature: 'debit', type: 'Gastos' },
        { code: '601.01', name: 'Sueldos y salarios', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.02', name: 'Compensaciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.03', name: 'Tiempos extras', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.04', name: 'Premios de asistencia', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.05', name: 'Premios de puntualidad', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.06', name: 'Vacaciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.07', name: 'Prima vacacional', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.08', name: 'Prima dominical', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.09', name: 'Días festivos', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.10', name: 'Gratificaciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.11', name: 'Primas de antigüedad', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.12', name: 'Aguinaldo', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.13', name: 'Indemnizaciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.14', name: 'Destajo', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.15', name: 'Despensa', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.16', name: 'Transporte', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.17', name: 'Servicio médico', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.18', name: 'Ayuda en gastos funerarios', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.19', name: 'Fondo de ahorro', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.20', name: 'Cuotas sindicales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.21', name: 'PTU', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.22', name: 'Estímulo al personal', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.23', name: 'Previsión social', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.24', name: 'Aportaciones para el plan de jubilación', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.25', name: 'Otras prestaciones al personal', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.26', name: 'Cuotas al IMSS', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.27', name: 'Aportaciones al infonavit', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.28', name: 'Aportaciones al SAR', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.29', name: 'Impuesto estatal sobre nóminas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.30', name: 'Otras aportaciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.31', name: 'Asimilados a salarios', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.32', name: 'Servicios administrativos', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.33', name: 'Servicios administrativos partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.34', name: 'Honorarios a personas físicas residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.35', name: 'Honorarios a personas físicas residentes nacionales partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.36', name: 'Honorarios a personas físicas residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.37', name: 'Honorarios a personas físicas residentes del extranjero partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.38', name: 'Honorarios a personas morales residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.39', name: 'Honorarios a personas morales residentes nacionales partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.40', name: 'Honorarios a personas morales residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.41', name: 'Honorarios a personas morales residentes del extranjero partes relacionadas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.42', name: 'Honorarios aduanales personas físicas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.43', name: 'Honorarios aduanales personas morales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.44', name: 'Honorarios al consejo de administración', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.45', name: 'Arrendamiento a personas físicas residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.46', name: 'Arrendamiento a personas morales residentes nacionales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.47', name: 'Arrendamiento a residentes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.48', name: 'Combustibles y lubricantes', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.49', name: 'Viáticos y gastos de viaje', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.50', name: 'Teléfono, internet', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.51', name: 'Agua', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.52', name: 'Energía eléctrica', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.53', name: 'Vigilancia y seguridad', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.54', name: 'Limpieza', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.55', name: 'Papelería y artículos de oficina', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.56', name: 'Mantenimiento y conservación', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.57', name: 'Seguros y fianzas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.58', name: 'Otros impuestos y derechos', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.59', name: 'Recargos fiscales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.60', name: 'Cuotas y suscripciones', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.61', name: 'Propaganda y publicidad', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.62', name: 'Capacitación al personal', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.63', name: 'Donativos y ayudas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.64', name: 'Asistencia técnica', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.65', name: 'Regalías sujetas a otros porcentajes', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.66', name: 'Regalías sujetas al 5%', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.67', name: 'Regalías sujetas al 10%', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.68', name: 'Regalías sujetas al 15%', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.69', name: 'Regalías sujetas al 25%', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.70', name: 'Regalías sujetas al 30%', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.71', name: 'Regalías sin retención', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.72', name: 'Fletes y acarreos', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.73', name: 'Gastos de importación', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.74', name: 'Comisiones sobre ventas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.75', name: 'Comisiones por tarjetas de crédito', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.76', name: 'Patentes y marcas', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.77', name: 'Uniformes', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.78', name: 'Prediales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.79', name: 'Gastos generales de urbanización', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.80', name: 'Gastos generales de construcción', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.81', name: 'Fletes del extranjero', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.82', name: 'Recolección de bienes del sector agropecuario y/o ganadero', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.83', name: 'Gastos no deducibles (sin requisitos fiscales)', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        { code: '601.84', name: 'Otros gastos generales', level: 3, parent_code: '601', account_nature: 'debit', type: 'Gastos' },
        
        // Gastos de venta - 602
        { code: '602', name: 'Gastos de venta', level: 2, parent_code: '600', account_nature: 'debit', type: 'Gastos' },
        { code: '602.01', name: 'Sueldos y salarios', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.02', name: 'Compensaciones', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.48', name: 'Combustibles y lubricantes', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.49', name: 'Viáticos y gastos de viaje', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.50', name: 'Teléfono, internet', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.61', name: 'Propaganda y publicidad', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.74', name: 'Comisiones sobre ventas', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        { code: '602.84', name: 'Otros gastos de venta', level: 3, parent_code: '602', account_nature: 'debit', type: 'Gastos' },
        
        // Gastos de administración - 603
        { code: '603', name: 'Gastos de administración', level: 2, parent_code: '600', account_nature: 'debit', type: 'Gastos' },
        { code: '603.01', name: 'Sueldos y salarios', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.02', name: 'Compensaciones', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.12', name: 'Aguinaldo', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.26', name: 'Cuotas al IMSS', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.27', name: 'Aportaciones al infonavit', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.50', name: 'Teléfono, internet', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.56', name: 'Mantenimiento y conservación', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' },
        { code: '603.84', name: 'Otros gastos de administración', level: 3, parent_code: '603', account_nature: 'debit', type: 'Gastos' }
      ];
          ...
          if (existingResult.rows.length > 0) {
            ...
            await pool.query(`
              ...
              SET name = $1, level = $2, parent_id = $3, sat_code = $4, 
                  account_nature = $5, description = $6, type = $7, updated_at = NOW()
              WHERE code = $8
            `, [
              satCode.name,
              satCode.level,
              ...
              `Código SAT oficial - ${satCode.type}`,
              satCode.type,
              satCode.code
            ]);
            updatedCount++;
            ...
            await pool.query(`
              INSERT INTO accounting_categories 
              (code, name, level, parent_id, sat_code, account_nature, is_active, description, type, created_at, updated_at)
